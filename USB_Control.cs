...
namespace CNC_Drill_Controller1
{
    class USB_Control : IUSB_Controller
    {
        ...
        {
            var x = (byte)(X_Abs_Location & GlobalProperties.stepBytesMask[GlobalProperties.stepMode]);
            x = GlobalProperties.stepBytes[GlobalProperties.stepMode][x]; //bits 0-3
        ...
        {
            var y = (byte)(Y_Abs_Location & GlobalProperties.stepBytesMask[GlobalProperties.stepMode]);
            y = GlobalProperties.stepBytes[GlobalProperties.stepMode][y]; //bits 0-3
